...
export const DEMO_XRAYS: DemoXRay[] = [
  // John Smith X-rays
  {
    id: 'xray-001',
    visitId: 'visit-001',
    imageUrl: 'https://via.placeholder.com/800x600/1e40af/ffffff?text=John+Smith+Baseline+X-Ray',
    type: 'baseline',
  ...
  },
  {
    id: 'xray-002',
    visitId: 'visit-002',
    imageUrl: 'https://via.placeholder.com/800x600/dc2626/ffffff?text=John+Smith+Current+X-Ray',
    type: 'current',
  ...
  // Emily Davis X-rays
  {
    id: 'xray-003',
    visitId: 'visit-003',
    imageUrl: 'https://via.placeholder.com/800x600/059669/ffffff?text=Emily+Davis+Baseline+X-Ray',
    type: 'baseline',
  ...
  },
  {
    id: 'xray-004',
    visitId: 'visit-004',
    imageUrl: 'https://via.placeholder.com/800x600/7c3aed/ffffff?text=Emily+Davis+Current+X-Ray',
    type: 'current',
  ...
  // Michael Wilson X-rays
  {
    id: 'xray-005',
    visitId: 'visit-005',
    imageUrl: 'https://via.placeholder.com/800x600/f59e0b/ffffff?text=Michael+Wilson+Baseline+X-Ray',
    type: 'baseline',
  ...
  },
  {
    id: 'xray-006',
    visitId: 'visit-006',
    imageUrl: 'https://via.placeholder.com/800x600/06b6d4/ffffff?text=Michael+Wilson+Current+X-Ray',
    type: 'current',
